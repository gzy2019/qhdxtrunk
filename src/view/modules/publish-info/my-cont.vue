  ...
  <div class="search">
    <Card>
      <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
        <Form-item label="标题" prop="contentTitle">
          <Input
            type="text"
      ...
      <Row>
        ...
        <i-col span="24" type="flex" justify="end" class="page" style="text-align:right">
          <Page
...
export default {
  ...
  function newFunction() {
    return this.dataForm.channelIdPath[this.dataForm.channelIdPath.length-1];
  }
