  ...
  <div class="search">
    <Card>
        <Form ref="searchForm" :model="searchForm" @keydown.enter.native="handleSearch" inline :label-width="70" class="search-form">
          <Form-item label="会议名称" prop="meetingTopic">
            <Input type="text" v-model="searchForm.meetingTopic" clearable placeholder="请输入会议名称" style="width: 180px" />
          </Form-item>
          <FormItem label="申请教师" prop="teacherId">
              <TeacherSelect v-model="searchForm.teacherId" :clearable="true" style="width: 180px"></TeacherSelect>
          </FormItem>
...
export default {
  ...
  components: { AchievementSubsidizeForm, AchievementSubsidizeView, TeacherSelect },
  data () {
    return {
      loading: true,
      exportLoading: false,
