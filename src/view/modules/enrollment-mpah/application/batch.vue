  ...
  <div class="search">
    <Card>
      ...
      <Row class="operation btn_group" style="margin-bottom: 10px;">
        ...
        <Button @click="deleteProject" :disabled="selectedList.length === 0" type="primary" icon="ios-trash-outline">批量删除</Button>
        </Col>
      </Row>
      <Row>
...
import api from '@/api/mpah/project'
export default {
  name: 'batch',
  components: {
    Tables,
            ...
            return h(
              'div',
              {
                on: {
                  click: val => {
                    this.$router.push({
                      name: 'enrollment-mpah/application/application-status',
