    ...
    <Card>
      <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
        ...
        <Form-item label="课程名称" prop="courseName">
          <Input type="text" v-model="searchForm.courseName" clearable placeholder="请输入课程名称" style="width: 180px" />
        </Form-item>
...
export default {
  ...
  methods: {
    ...
    viewDetail (obj) {
      this.$router.push({ name: 'course-select/application-view', params: { courseId: obj.id, batchId: this.searchForm.batchId } })
    }
  },
  mounted () {
    this.init()
