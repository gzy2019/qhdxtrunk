    ...
    <Card>
      <Form ref="searchForm" :model="searchForm" inline :label-width="60" class="search-form">
        ...
        <Form-item label="学号" prop="stuCode">
          <Input type="text" v-model="searchForm.stuCode" clearable placeholder="请输入学号" style="width: 170px" />
        </Form-item>
        <Form-item label="国籍" prop="country">
          <DicSelect v-model="searchForm.country" dtype="country" :clearable="true" style="width: 170px"></DicSelect>
        </Form-item>
        <Form-item label="学生类别" prop="stuType">
          <DicSelect v-model="searchForm.stuType" dtype="student-type" :clearable="true" style="width: 170px"></DicSelect>
        </Form-item>
        <Form-item label="学生班级" prop="classId">
          <ClassSelect v-model="searchForm.classId" :clearable="true" style="width: 170px"></ClassSelect>
        </Form-item>
