    ...
    <Card>
      <Form ref="searchForm" :model="searchForm" @keydown.enter.native="handleSearch" inline :label-width="70" class="search-form">
        <Form-item label="会议名称" prop="name">
          <Input type="text" v-model="searchForm.name" clearable placeholder="请输入会议名称" style="width: 180px" />
        </Form-item>
        <Form-item label="审核状态" prop="approveStatus">
          <Select v-model="searchForm.approveStatus" @on-change="handleSearch" placeholder="请选择" clearable style="width: 180px">
        ...
        <Form-item label="会议室" prop="meetingRoomId">
          <Select v-model="searchForm.meetingRoomId" @on-change="handleSearch" placeholder="请选择" clearable style="width: 180px">
...
export default {
  ...
  methods: {
    ...
    getMeetingRoomBookList () {
      this.loading = true
      api.getMeetingRoomBookList(this.searchForm).then(res => {
        this.loading = false
        this.selectedList = []
